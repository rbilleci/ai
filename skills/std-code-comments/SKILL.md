---
name: std-code-comments
description: Code comment standards. Use when writing, editing, or reviewing source code, comments, docstrings, or symbol names.
---

# Code Standards

Apply `../std-writing/SKILL.md` to every comment this rule permits.
